...
public class Dialogs.QuickFind.QuickFindItem : GLib.Object {
    ...
    public static void on_list_item_setup (Gtk.SignalListItemFactory factory, GLib.Object list_item_obj) {
    ...
    public static void on_list_item_bind (Gtk.SignalListItemFactory factory, GLib.Object list_item_obj) {
        var list_item = (Gtk.ListItem) list_item_obj;
        ...
        if (item.base_object is Objects.Project) {
            ...
            main_grid.attach (name_label, 1, 0);
        } else if (item.base_object is Objects.Filters.Today || item.base_object is Objects.Filters.Scheduled ||
        item.base_object is Objects.Filters.Completed || item.base_object is Objects.Filters.Tomorrow ||
        item.base_object is Objects.Filters.Labels || item.base_object is Objects.Filters.Scheduled ||
        item.base_object is Objects.Filters.Pinboard || item.base_object is Objects.Filters.Anytime ||
        item.base_object is Objects.Filters.Repeating || item.base_object is Objects.Filters.Unlabeled ||
        item.base_object is Objects.Filters.AllItems) {
    ...
    public static void on_list_item_unbind (Gtk.SignalListItemFactory factory, GLib.Object list_item_obj) {
        var list_item = (Gtk.ListItem) list_item_obj;
        var item = (QuickFindItem) list_item.item;
        var main_grid = (Gtk.Grid) list_item.child;
    ...
    public static void on_list_item_teardown (Gtk.SignalListItemFactory factory, GLib.Object list_item_obj) {
        var list_item = (Gtk.ListItem) list_item_obj;
        var main_grid = (Gtk.Grid) list_item.child;
    ...
    public static void on_header_setup (Object object) {
    ...
    public static void on_header_bind (Object object) {
        var header = (Gtk.ListHeader) object;
